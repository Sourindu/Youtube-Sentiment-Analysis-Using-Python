...
if __name__ == "__main__":
  ...
  try:
    comments = []
    video_comment_threads = get_comment_threads(youtube, 'EgqUJOudrcM', comments)
    ...
    for k in sorted(total_video_score):
        total_video_score[k] = (total_video_score[k]**(0.1))/len(comment);
