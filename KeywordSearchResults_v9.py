...
import os;
import sys;
from CommentsTest_v12 import ProcessVideoID;
...
##  print(video_Table)
  ...
  print (heading_print.format(title));
...
## sorting the table
  ...
  print ("{:<20} {:<20} {:<20} {:<20} {:<20}".format('Video ID','Compound','Positive','Negative','Neutral','textblob_polarity','lexicon_score','classifier_score'))
