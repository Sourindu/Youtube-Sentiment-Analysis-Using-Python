...
##          print(lexicon_result);
            com_Lex_Score = pos_lexicon - neg_lexicon
            if(com_Lex_Score < 0):
                com_Lex_Score = -1*(abs(com_Lex_Score)/comlen**2)
            else:
                com_Lex_Score = (com_Lex_Score/comlen)**2
                
            total_video_score['lexicon_score']= total_video_score['lexicon_score'] + com_Lex_Score;            
