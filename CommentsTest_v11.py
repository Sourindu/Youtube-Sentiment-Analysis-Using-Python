...
##    video_comment_threads = get_comment_threads(youtube, '-8N9UR6OTCs', comments);
    total_video_score = {'compound':0.0,'neg':0.0,'neu':0.0,'pos':0.0,'textblob_polarity':0.0,'pos_lexicon':0.0,'neg_lexicon':0.0,'neutral_lexicon':0.0};
...
##            print(lexicon_result);
            total_video_score['pos_lexicon']=pos_lexicon;
            total_video_score['neg_lexicon']=neg_lexicon;
            total_video_score['neutral_lexicon']=neutral_lexicon;
##            print();
########################################### vader #########################################################
